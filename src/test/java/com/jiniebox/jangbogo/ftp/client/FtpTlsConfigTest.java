 ...
 *
 * <p>프로퍼티 파일을 사용하여 FTP 서버 정보를 관리하는 방법을 테스트합니다.
 *
 * <p>사용 방법:
 *
 * <ol>
 *   <li>src/test/resources/ftp-test.properties.example을 ftp-test.properties로 복사
 *   <li>실제 FTP 서버 정보로 값 변경
 *   <li>@Disabled 어노테이션 제거 후 테스트 실행
 * </ol>
 *
 * @author jiniebox.com
 * @version 1.0
...
class FtpTlsConfigTest {
  ...
  void testLoadFtpConfig() {
    ...
    Assumptions.assumeTrue(host != null || props != null, "FTP 설정이 없어 테스트를 스킵합니다");
  }
  ...
  static class FtpConfig {
    ...
    public String toString() {
      ...
      return String.format(
          "FtpConfig{host='%s', port=%d, user='%s', protocol='%s', mode=%s}",
