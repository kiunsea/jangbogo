...
/**
 * 관리자 계정/비밀번호를 중앙에서 관리하고
 * config/admin.properties 파일과 동기화하는 서비스.
 */
@Service
public class AdminCredentialService {
     ...
     */
    public void updateCredentials(String newAdminId, String newAdminPass, boolean updatePassword) throws IOException {
        ...
        try {
            ...
            String passwordToSave = updatePassword ? (newAdminPass != null ? newAdminPass : "") : currentAdminPass;
