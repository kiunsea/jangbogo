...
public class ExportService {
     ...
     * @throws Exception
     */
    public String exportOrdersBySeqList(String savePath, String format, List<Integer> orderSeqs) throws Exception {
    ...
    private ExportData collectOrderDataBySeqList(List<Integer> orderSeqs) throws Exception {
        ...
        // 내보내기 정보 설정
        exportData.setExportInfoValue("export_date", LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
        ...
        for (JSONObject orderJson : allOrders) {
            try {
                ...
                String mallName = orderJson.get("mall_name") != null ? String.valueOf(orderJson.get("mall_name")) : "";
